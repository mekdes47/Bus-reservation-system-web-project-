...
<html>
	<head>
        ...
        // }
        ?>
		<title>Admin Login | Bus Reservation System</title>
	</head>
    <style>
        body {
            ...
            <div class="card-body">
                     <form id="login-frm">
                        ...
                        <div class="form-group text-right">
                            <button class="btn btn-success btn-block" name="submit">Login as Admin mekdes</button>
							<br>
